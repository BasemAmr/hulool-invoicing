export type TemplateParentCategory = "standard" | "system_default" | "company_chosen";
...
export const TEMPLATES_REGISTRY: Record<string, TemplateDefinition> = {
  ...
  masdar_materials_no_terms: {
    ...
    nameEn: "Template 17 (Without Terms)",
    parentCategory: "standard",
    category: "modern",
    primaryColor: "#E11D48",
    accentColor: "#1E3A8A",
...
export const DEFAULT_TEMPLATE: TemplateDefinition = TEMPLATES_REGISTRY.contracting_advance || TEMPLATES_REGISTRY.simple_red!;
...
export const DEFAULT_RECEIPT_TEMPLATE: TemplateDefinition = RECEIPT_TEMPLATES_REGISTRY.receipt_design_work || RECEIPT_TEMPLATES_REGISTRY.receipt_standard!;
